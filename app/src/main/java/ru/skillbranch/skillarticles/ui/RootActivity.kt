...
class RootActivity() : BaseActivity<ArticleViewModel>(), IArticleView, Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<RootActivity> {
        override fun createFromParcel(parcel: Parcel): RootActivity {
            return RootActivity(parcel)
        }

        override fun newArray(size: Int): Array<RootActivity?> {
